/**
 * QRCode.js - Standard Complete Cross-browser QR Code Generator
 * Auto-detects TypeNumber (1 to 40) for arbitrary length strings / URLs
 */
(function(global) {
  ...
  var QRUtil = {
    PATTERN_POSITION_TABLE: [
      ...
      [6, 26, 50, 74, 98], [6, 30, 54, 78, 102], [6, 28, 54, 80, 106], [6, 32, 58, 84, 110], [6, 30, 58, 86, 114], [6, 34, 62, 90, 118], [6, 26, 50, 74, 98, 122],
      [6, 30, 54, 78, 102, 126], [6, 26, 52, 78, 104, 130], [6, 30, 56, 82, 108, 134], [6, 34, 60, 86, 112, 138], [6, 30, 58, 86, 114, 142], [6, 34, 62, 90, 118, 146],
  ...
  // QRCode Wrapper for DOM Canvas/Img rendering
  function QRCode(el, options) {
    if (typeof options === 'string') options = { text: options };
    this.options = Object.assign({
      width: 256,
      height: 256,
      typeNumber: 0, // 0 = Auto-detect based on data length!
      colorDark: "#000000",
      colorLight: "#ffffff",
  ...
  QRCode.prototype.makeCode = function(text) {
    this._oQRCode = new QRCodeModel(this.options.typeNumber || 0, this.options.correctLevel);
